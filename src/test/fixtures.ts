...
export function fixtureTrades(now: string = today()): Trade[] {
  ...
  const rows: Array<Partial<Trade> & { date: string }> = [
    ...
    { date: d(6), pnl: -320, time: '10:05', lotSize: 0.6, riskAmount: 320, riskPct: 3.2, rMultiple: -1, reason: REASONS[2], tags: ['london', 'sweep'], reasonTags: ['chased', 'moved-stop', 'revenge'], ruleViolations: [{ code: 'risk-exceeded', message: 'Risked 3.2% against your 1% limit.' }] },
    { date: d(7), pnl: 0, time: '11:00', lotSize: 0.1, riskAmount: 60, riskPct: 0.6, rMultiple: 0, reason: REASONS[6] },
    { date: d(8), pnl: 425, time: '15:30', lotSize: 0.25, riskAmount: 140, riskPct: 1.4, rMultiple: 3.04, reason: REASONS[4], tags: ['ny-open'], charts: [
      { url: 'https://www.tradingview.com/x/example1', timeframe: 'D1', bias: 'bullish', label: 'before' },
      { url: 'https://www.tradingview.com/x/example2', timeframe: 'H4', bias: 'bullish' },
      { url: 'https://www.tradingview.com/x/example3', timeframe: 'm15', label: 'entry' },
    ], reasonTags: ['clean-entry', 'followed-plan'] },
