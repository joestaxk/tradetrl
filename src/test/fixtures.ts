...
export function fixtureTrades(now: string = today()): Trade[] {
  ...
  const rows: Array<Partial<Trade> & { date: string }> = [
    { date: d(1), pnl: 240, time: '08:40', lotSize: 0.2, riskAmount: 120, riskPct: 1.2, rMultiple: 2, reason: REASONS[0], tags: ['london', 'sweep'] },
    { date: d(1), pnl: -120, time: '13:10', lotSize: 0.2, riskAmount: 120, riskPct: 1.2, rMultiple: -1 },
    { date: d(2), pnl: 610, time: '09:05', lotSize: 0.3, riskAmount: 180, riskPct: 1.8, rMultiple: 3.39, reason: REASONS[1], tags: ['continuation'] },
    ...
    { date: d(15), pnl: 880, time: '09:20', lotSize: 0.4, riskAmount: 220, riskPct: 2.2, rMultiple: 4, reason: REASONS[0], tags: ['london', 'sweep'], ruleViolations: [{ code: 'risk-exceeded', message: 'Risked 2.2% against your 1% limit.' }] },
    ...
    { date: d(22), pnl: 520, time: '13:50', lotSize: 0.3, riskAmount: 160, riskPct: 1.6, rMultiple: 3.25, reason: REASONS[4], tags: ['ny-open'] },
    ...
    { date: d(27), pnl: 730, time: '09:40', lotSize: 0.35, riskAmount: 190, riskPct: 1.9, rMultiple: 3.84, reason: REASONS[1], tags: ['continuation', 'london'] },
    { date: d(28), pnl: -130, time: '15:05', lotSize: 0.2, riskAmount: 120, riskPct: 1.2, rMultiple: -1.08 },
  ]
